...
CREATE TABLE tabla_maestra_detalle (
  id_maestro_detalle int(11) NOT NULL,
  id_maestro int(11) NOT NULL,
  valor varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE departamento(
idDepa int(5) NOT NULL PRIMARY KEY,
departamento varchar(50) DEFAULT NULL
);

CREATE TABLE ciudad (
 idCiu int(5) NOT NULL  PRIMARY KEY ,
 ciudad varchar(50) DEFAULT NULL,
 idDepa int(5) DEFAULT NULL,
 CONSTRAINT FOREIGN KEY (idDepa) REFERENCES departamento(idDepa)
);

CREATE TABLE distrito (
 idDist int(5) NOT NULL  PRIMARY KEY,
 distrito varchar(50) DEFAULT NULL,
 idCiu int(5) DEFAULT NULL,
 CONSTRAINT FOREIGN KEY (idCiu) REFERENCES ciudad(idCiu)
);
...
CREATE TABLE users (
  ...
  respuestaSecreta varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  idDist int(5),
  role_id bigint(20) UNSIGNED NOT NULL,
  foto varchar(200),
  CONSTRAINT FOREIGN KEY (idDist) REFERENCES distrito(idDist)
);
...
CREATE TABLE producto_detalle (
  id_producto_detalle bigint(20) UNSIGNED NOT NULL,
  id_producto bigint(20) UNSIGNED NOT NULL,
  imagen varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE orden_feedback (
  id_orden_feedback int(11) NOT NULL,
  id_orden bigint(20) UNSIGNED NOT NULL,
  comentario varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  id_tipo_feedback int(11) NOT NULL,
...
ALTER TABLE orden_detalle
  ...
  ADD KEY FK_orden_detalle_orden (id_orden),
  ADD KEY id_producto (id_producto);

ALTER TABLE orden_feedback
  ADD PRIMARY KEY (id_orden_feedback),
  ADD KEY FK_orden_feedback_orden (id_orden);
...
ALTER TABLE producto
  ...
  ADD KEY fk_producto_categoria (id_subCategoria),
...
ALTER TABLE tabla_maestra_detalle
  ADD PRIMARY KEY (id_maestro_detalle),
...
ALTER TABLE orden
  MODIFY id_orden bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

ALTER TABLE orden_detalle
  MODIFY id_orden_detalle int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

ALTER TABLE orden_feedback
  MODIFY id_orden_feedback int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE producto_detalle
  MODIFY id_producto_detalle bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE tabla_maestra_detalle
  MODIFY id_maestro_detalle int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE orden_detalle
  ...
  ADD CONSTRAINT FK_orden_detalle_producto FOREIGN KEY (id_producto) REFERENCES producto (id_producto);
...
ALTER TABLE producto_detalle
  ADD CONSTRAINT fk_producto_detalle_producto FOREIGN KEY (id_producto) REFERENCES producto (id_producto);
...
(4, 'CATEGORIA 4', '2022-08-13', 1),
(5, 'CATEGORIA 4', '2022-08-13', 1),
(6, 'CATEGORIA 4', '2022-08-13', 1),
...
(1, '2022_08_09_221236_create_categoria_table', 1),
(2, '2022_08_09_221236_create_failed_jobs_table', 1),
(3, '2022_08_09_221236_create_model_has_permissions_table', 1),
(4, '2022_08_09_221236_create_model_has_roles_table', 1),
(5, '2022_08_09_221236_create_orden_detalle_table', 1),
(6, '2022_08_09_221236_create_orden_feedback_table', 1),
(7, '2022_08_09_221236_create_orden_table', 1),
(8, '2022_08_09_221236_create_password_resets_table', 1),
(9, '2022_08_09_221236_create_permissions_table', 1),
(10, '2022_08_09_221236_create_producto_detalle_table', 1),
(11, '2022_08_09_221236_create_producto_table', 1),
(12, '2022_08_09_221236_create_role_has_permissions_table', 1),
(13, '2022_08_09_221236_create_roles_table', 1),
(14, '2022_08_09_221236_create_tabla_maestra_detalle_table', 1),
(15, '2022_08_09_221236_create_tabla_maestra_table', 1),
(16, '2022_08_09_221236_create_users_table', 1),
(17, '2022_08_09_221237_add_foreign_keys_to_model_has_permissions_table', 1),
(18, '2022_08_09_221237_add_foreign_keys_to_model_has_roles_table', 1),
(19, '2022_08_09_221237_add_foreign_keys_to_orden_detalle_table', 1),
(20, '2022_08_09_221237_add_foreign_keys_to_orden_feedback_table', 1),
(21, '2022_08_09_221237_add_foreign_keys_to_orden_table', 1),
(22, '2022_08_09_221237_add_foreign_keys_to_producto_detalle_table', 1),
(23, '2022_08_09_221237_add_foreign_keys_to_producto_table', 1),
(24, '2022_08_09_221237_add_foreign_keys_to_role_has_permissions_table', 1);

INSERT INTO permissions (id, name, guard_name, created_at, updated_at) VALUES
(1, 'dashboard', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(2, 'categoria.index', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(3, 'categoria.create', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(4, 'categoria.edit', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(5, 'producto.index', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(6, 'producto.create', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(7, 'producto.edit', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(8, 'orden.index', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(9, 'orden.create', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(10, 'orden.edit', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(11, 'feedback.index', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55');

INSERT INTO tabla_maestra (id_maestro, texto) VALUES
(1, 'Tipo Pago'),
(2, 'FeedBack');


INSERT INTO tabla_maestra_detalle (id_maestro_detalle, id_maestro, valor) VALUES
(1, 1, 'Efectivo'),
(2, 1, 'Tarjeta'),
(3, 1, 'Yape'),
(4, 2, 'Reclamo'),
...
(1, 'admin', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(2, 'proveedor', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(3, 'cliente', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55'),
(4, 'web Master', 'web', '2022-08-13 16:37:55', '2022-08-13 16:37:55');
...
INSERT INTO ciudad (idCiu, ciudad, idDepa) VALUES
(1, 'CHACHAPOYAS ', 1),
(2, 'BAGUA', 1),
(3, 'BONGARA', 1),
(4, 'CONDORCANQUI', 1),
...
INSERT INTO distrito (idDist, distrito, idCiu) VALUES
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
...
INSERT INTO users (id, name, email, apellido_paterno, documento, celular, direccion, urbanizacion, password, respuestaSecreta,idDist,role_id) VALUES
(11, 'ADMIN', 'dev@gmail.com', NULL, NULL, NULL, NULL, NULL, '$2y$10$s8JG./y.eth/T7noTf0EFemqhnAIJfIpgpAd81XGD7A1RX/0DqL5O', NULL,1285,'1'),
(12, 'PROVEEDOR1', 'proveedor1@gmail.com', NULL, NULL, NULL, NULL, NULL, '$2y$10$aWhx8wIEfy7NG2rN9oLsnu5TaVrMX8GyJQ69ANxlJeCQylCFUNCcm', NULL,1285,'2'),
(13, 'CLIENTE1', 'cliente1@gmail.com', NULL, NULL, NULL, NULL, NULL, '$2y$10$uOpwz0DJG0oxFNBBcK0N7eIT/YS6MPUbxOgFXrq.1WzxFR1As2lVW', NULL,1285,'3'),
(14, 'WEBMASTER', 'webmaster@gmail.com', NULL, NULL, NULL, NULL, NULL, '$2y$10$uOpwz0DJG0oxFNBBcK0N7eIT/YS6MPUbxOgFXrq.1WzxFR1As2lVW', NULL,1285,'4');

INSERT INTO producto (id_producto, id_subCategoria, id_proveedor, nombre, precio, stock, descripcion, imagen,oferta) VALUES
(1, 2, 11, 'CAMISETA NEGRA PERU', 10.20, 5, 'Camiseta bonita de peruano', 'produ3.png',0),
(2, 2, 11, 'CAMISETA ROJA', 50.00, 13, 'CAMISETA ROJA BUENA CALIDAD', 'produ1.png',0),
(3, 1, 11, 'CAMISETA DE ALGODON', 60.00, 3, 'CAMISETA DE EXCELENTE CALIDAD', 'produ2.png',0),
(4, 2, 11, 'CAMISETA CON CUELLO', 45.50, 18, 'CAMISETA CON CUELLO REDONDO', 'produ5.png',1),
(5, 1, 11, 'POLO BLANCO', 15.00, 90, 'POLO BLANCO ESCOLAR', 'produ2.png',0),
(7, 1, 11, 'POLO PERUANO', 26.70, 15, 'POLO DE PERU NUEVO', 'produ6.png',0);

INSERT INTO producto_detalle (id_producto_detalle, id_producto, imagen) VALUES
(1, 1, 'produ3.png'),
(2, 2, 'produ1.png'),
(3, 3, 'produ2.png'),
(4, 4, 'produ5.png'),
